...
const Doctors = () => {
  ...
  return (
    <div className="bg-[#cdf2f1] py-[15vh]">
      ...
      <div className="grid lg:grid-cols-3 grid-cols-1 gap-x-10 gap-y-10 mt-10 lg:w-[80vw] w-[90vw] mx-auto items-center">
        {doctors.map((doctor) => (
          <div key={doctor.id} className="flex flex-col">
            <div className="bg-[#3aaba9] lg:w-[450px] w-[90vw] mx-auto h-[300px] rounded-t-2xl">
                <Image src={doctor.image} alt="doctor" className="w-[100%] h-[100%] object-cover" />
            </div>
            <div className="bg-[#fff] lg:w-[450px] w-[90vw] flex flex-col rounded-b-2xl items-center py-4">
